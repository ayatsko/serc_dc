...
# note these later on if they need to be pulled out 
...
name.list <- c("BDS", "DC", "TOPDIAM", "DBH", "LENGTH", "SPCODE", "HEIGHT")
# breaks with GC and INTEG included - therefore take out 
...
# all is looking better - trouble shooting with STEMTAG - go through line by line in expand.dataframe 
