...
# save t0 start deadwood sum (representing total in decay class 1)
t0s <- colSums(N)

# first year - 50 DC1 have a certain probability of staying as 1's, going to 2's, and so on
N <- (sweep(decay.prob1yr, MARGIN=2, N, `*`)) 

# sum of N[, 1] should be ~50
sum(N[, 1])
