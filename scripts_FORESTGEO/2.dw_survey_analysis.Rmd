...
```{r}
# not plotting the decay class 6's (moved out of system)
...
# taking out 6's from bar plots for now (showing species distribution), but still in the data set 
...
# might want to go back through and see where 2014 = 3 and 2017 / 2021 are NA (does this mean that they are not found?)

decay.mat <- matrix(0, nrow = 4, ncol = 3)
...
# timeframe and empty simulation matrix
yrs <- 50
N <- matrix(0, ncol = yrs, nrow = 4)

# insert different starting conditions
# just influx of a bunch of 1s and 2s
N[, 1] <- matrix(c(300, 100, 0, 0), ncol = 1)
