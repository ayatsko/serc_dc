...
create plots that shows species distribution 
...
# ALTERNATE WAY of converting decay class - skip for now
...
now everything is in decay class scale 1-3! 
...
for(i in 1:nrow(data)) {
	decay.mat[data$DC.2017_3[i], data$DC.2014_3[i]] <- decay.mat[data$DC.2017_3[i], data$DC.2014_3[i]] + 1
}
